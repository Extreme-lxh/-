  ...
  <nav class="site-navbar" :class="'site-navbar--' + navbarLayoutType">
    <div class="site-navbar__header">
      <h1 class="site-navbar__brand" @click="$router.push({ name: 'home' })">
        <a class="site-navbar__brand-lg" href="javascript:;">教室资源管理平台</a>
        <!-- <a class="site-navbar__brand-mini" href="javascript:;">教室资源后台</a> -->
      </h1>
    </div>
        ...
        <el-menu-item class="site-navbar__avatar" index="3">
          <el-dropdown :show-timeout="0" placement="bottom">
            ...
            <el-dropdown-menu slot="dropdown">
              <el-dropdown-item v-if="$store.state.user.panduan=='管理员'||$store.state.user.panduan=='后勤'" @click.native="updateInfoHandle()">修改信息</el-dropdown-item>
    ...
    <!-- 弹窗, 修改信息 -->
    <update-info v-if="updateInfoVisible" ref="info"></update-info>
    <!-- 弹窗, 修改密码 -->
