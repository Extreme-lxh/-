<template>
  <div class="app-container">
    ...
    <el-dialog title="公告详情" width="50%" :visible.sync="dialogNotice">
      <el-row>
    ...
    <el-dialog title="添加公告" width="50%" :visible.sync="dialog">
      <el-row class="el-row">
        <el-row class="el-row">
          <el-col :span="span1">
            <span class="must">公告标题：</span>
          </el-col>
          <el-col :span="span2">
